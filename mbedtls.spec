...
%prep
%setup -q -n mbedtls-3.6.0
cd %{_builddir}/mbedtls-3.6.0
%patch -P 1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1717004172
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libmbedcrypto.so.3.6.0
/V3/usr/lib64/libmbedtls.so.3.6.0
/V3/usr/lib64/libmbedx509.so.3.6.0
/usr/lib64/libmbedcrypto.so.16
/usr/lib64/libmbedcrypto.so.3.6.0
/usr/lib64/libmbedtls.so.21
/usr/lib64/libmbedtls.so.3.6.0
/usr/lib64/libmbedx509.so.3.6.0
