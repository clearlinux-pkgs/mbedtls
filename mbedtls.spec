...
Source0  : https://github.com/Mbed-TLS/mbedtls/releases/download/v3.6.3.1/mbedtls-3.6.3.1.tar.bz2
...
%prep
%setup -q -n mbedtls-3.6.3.1
cd %{_builddir}/mbedtls-3.6.3.1
%patch -P 1 -p1
pushd ..
cp -a mbedtls-3.6.3.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1749246368
mkdir -p clr-build
pushd clr-build
...
-DUSE_STATIC_MBEDTLS_LIBRARY=OFF  -G 'Unix Makefiles'
make  %{?_smp_mflags}
popd
pushd ../buildavx2/
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libmbedcrypto.so.3.6.3
/V3/usr/lib64/libmbedtls.so.3.6.3
/V3/usr/lib64/libmbedx509.so.3.6.3
/usr/lib64/libmbedcrypto.so.16
/usr/lib64/libmbedcrypto.so.3.6.3
/usr/lib64/libmbedtls.so.21
/usr/lib64/libmbedtls.so.3.6.3
/usr/lib64/libmbedx509.so.3.6.3
