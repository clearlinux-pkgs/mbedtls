...
Source0  : https://github.com/Mbed-TLS/mbedtls/archive/refs/tags/mbedtls-3.5.0.tar.gz
...
%prep
%setup -q -n mbedtls-mbedtls-3.5.0
cd %{_builddir}/mbedtls-mbedtls-3.5.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1697749761
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/mbedtls-mbedtls-%{version}/3rdparty/p256-m/p256-m/LICENSE %{buildroot}/usr/share/package-licenses/mbedtls/2b8b815229aa8a61e483fb4ba0588b8b6c491890 || :
cp %{_builddir}/mbedtls-mbedtls-%{version}/LICENSE %{buildroot}/usr/share/package-licenses/mbedtls/2b8b815229aa8a61e483fb4ba0588b8b6c491890 || :
pushd clr-build
%make_install
popd
...
/usr/share/package-licenses/mbedtls/2b8b815229aa8a61e483fb4ba0588b8b6c491890
